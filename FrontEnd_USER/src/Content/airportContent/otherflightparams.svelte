<script>
    ...
    let seat_class_list = [ { value : "economy", name : "economy" } ,
                       { value : "business", name : "business" }, 
                       //{ value : "premium", name : "Premium economy" },
                       { value : "first_class", name : "first_class" }
                        ]
    ...
    let default_seat_class = seat_class_list.find( seat_class_list => seat_class_list.value === lastFiveValues[3])?.name
