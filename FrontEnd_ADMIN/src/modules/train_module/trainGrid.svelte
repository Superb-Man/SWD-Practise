...
<Label class = "relative w-1/2" for = "src">
  ...
  <Select items= { fragmentArray(Boggy,compartments)[0] } id="text" placeholder = "Select Seat" bind:value = { selectedCompartment } class = " pl-8 font-bold font-serif bg-gray-100 border-4 border-gray-400 h-18 rounded-lg hover:bg-green-200 cursor-pointer "    />
