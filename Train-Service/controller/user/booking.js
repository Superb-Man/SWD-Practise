...
//     req.body.booked_deatils = [[4,0,1],[2,1,1],[5,2,1]] ;
//     obj = req.body ;
...
//             text : 'SELECT "air_details".dimensions FROM "air_details" JOIN "air_schedule_info" ON "air_schedule_info".air_id = "air_details".air_id  WHERE schedule_id = $1',
//             values : [obj.schedule_id]
//         }

//         const dimension = (await airPool.query(dimension_query)).rows[0].dimensions[class_id] ;
//         console.log(class_id) ;
...
//                 values : [class_id+1,dimension[1]*obj.booked_deatils[i][0]+obj.booked_deatils[i][1]+1,3,1,obj.schedule_id]
//             }
